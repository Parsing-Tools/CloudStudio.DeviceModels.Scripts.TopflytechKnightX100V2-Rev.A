...
# Parsing + Configuration Script – Topflytech KnightX 100 V2 - Rev. A

This **Parsing + Configuration** script is designed for the **Topflytech KnightX 100 V2** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – Topflytech KnightX 100 V2 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **Topflytech KnightX 100 V2** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
